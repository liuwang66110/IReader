package com.terrence.iread.api;
...
public interface UserService {
     ...
     * @return
     */
    @POST(com.terrence.iread.api.ModelPath.USER + "/register")
    @FormUrlEncoded
     ...
     * @return
     */
    @GET(com.terrence.iread.api.ModelPath.USER + "/login")
     ...
     * @return
     */
    @HTTP(method = "DELETE", path = com.terrence.iread.api.ModelPath.USER + "/bookshelf", hasBody = true)
