package com.terrence.iread.widget.page;
...
import com.terrence.iread.db.entity.BookRecordBean;
import com.terrence.iread.db.entity.CollBookBean;
import com.terrence.iread.db.helper.BookRecordHelper;
import com.terrence.iread.utils.Constant;
import com.terrence.iread.utils.IOUtils;
import com.terrence.iread.utils.ReadSettingManager;
import com.terrence.iread.utils.rxhelper.RxUtils;
import com.terrence.iread.utils.ScreenUtils;
import com.terrence.iread.utils.StringUtils;
...
public abstract class PageLoader {
    ...
    public void setBgColor(int theme) {
        if (isNightMode && theme == ReadSettingManager.NIGHT_MODE) {
            mTextColor = ContextCompat.getColor(IReaderApplication.getAppContext(), R.color.color_fff_99);
            mPageBg = ContextCompat.getColor(IReaderApplication.getAppContext(), R.color.black);
        } else if (isNightMode) {
            mBgTheme = theme;
            ...
            switch (theme) {
                case ReadSettingManager.READ_BG_DEFAULT:
                    mTextColor = ContextCompat.getColor(IReaderApplication.getAppContext(), R.color.color_2c);
                    mPageBg = ContextCompat.getColor(IReaderApplication.getAppContext(), R.color.color_cec29c);
                    break;
                case ReadSettingManager.READ_BG_1:
                    mTextColor = ContextCompat.getColor(IReaderApplication.getAppContext(), R.color.color_2f332d);
                    mPageBg = ContextCompat.getColor(IReaderApplication.getAppContext(), R.color.color_ccebcc);
                    break;
                case ReadSettingManager.READ_BG_2:
                    mTextColor = ContextCompat.getColor(IReaderApplication.getAppContext(), R.color.color_92918c);
                    mPageBg = ContextCompat.getColor(IReaderApplication.getAppContext(), R.color.color_aaa);
                    break;
                case ReadSettingManager.READ_BG_3:
                    mTextColor = ContextCompat.getColor(IReaderApplication.getAppContext(), R.color.color_383429);
                    mPageBg = ContextCompat.getColor(IReaderApplication.getAppContext(), R.color.color_d1cec5);
                    break;
                case ReadSettingManager.READ_BG_4:
                    mTextColor = ContextCompat.getColor(IReaderApplication.getAppContext(), R.color.color_627176);
                    mPageBg = ContextCompat.getColor(IReaderApplication.getAppContext(), R.color.color_001c27);
                    break;
            }
        }
