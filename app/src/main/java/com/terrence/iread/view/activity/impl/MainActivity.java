...
import com.terrence.iread.utils.SnackBarUtils;
import com.terrence.iread.utils.ThemeUtils;
import com.terrence.iread.utils.ToastUtils;
import com.terrence.iread.view.activity.ISetting;
import com.terrence.iread.view.adapter.MainMenuAdapter;
import com.terrence.iread.view.base.BaseActivity;
import com.terrence.iread.view.fragment.impl.BookClassifyFragment;
import com.terrence.iread.view.fragment.impl.BookShelfFragment;
import com.terrence.iread.view.fragment.impl.ScanBookFragment;
import com.terrence.iread.viewmodel.activity.VMSettingInfo;
import com.terrence.iread.widget.ResideLayout;
import com.terrence.iread.widget.theme.ColorRelativeLayout;
import com.terrence.iread.widget.theme.ColorUiUtil;
...
public class MainActivity extends BaseActivity implements ColorChooserDialog.ColorCallback, ISetting {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initThemeToolBar("书架", R.drawable.ic_classify, R.drawable.ic_search, v -> {
            mResideLayout.openPane();
        }, v -> {
            ToastUtils.show("还未开发~~~");
...
//                }
    ...
    protected void onResume() {
        ...
        try {
            ...
            Glide.with(mContext).load(R.mipmap.ic_icon)
                    .apply(new RequestOptions().transform(new CircleCrop()).diskCacheStrategy(DiskCacheStrategy.NONE).skipMemoryCache(true))
                    .into(mIvAvatar);
        } catch (Exception e) {
            e.printStackTrace();
