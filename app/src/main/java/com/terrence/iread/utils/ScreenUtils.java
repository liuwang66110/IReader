...
public class ScreenUtils {
    ...
    public static int getStatusBarHeight() {
        Resources resources = IReaderApplication.getAppContext().getResources();
    ...
    public static int getNavigationBarHeight() {
        ...
        Resources rs = IReaderApplication.getAppContext().getResources();
    ...
    public static DisplayMetrics getDisplayMetrics() {
        DisplayMetrics metrics = IReaderApplication.getAppContext()
                .getResources()
                .getDisplayMetrics();
        return metrics;
    }
