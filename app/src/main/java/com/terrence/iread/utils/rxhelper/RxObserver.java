...
import com.terrence.iread.view.activity.impl.LoginActivity;
    ...
    public void doOnNext(BaseData<T> data) {
        ...
        switch (data.getCode()) {
            ...
            case 60002:
                ...
                Intent intent = new Intent(IReaderApplication.getAppContext(), LoginActivity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                IReaderApplication.getAppContext().startActivity(intent);
                break;
            case 10005:
            case 40000:
            case 40001:
